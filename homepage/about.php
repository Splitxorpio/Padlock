    ...
    <div class="container">
        <div class="title" style="margin-top: 0px;">
            ...
            <p style="font-size: 15px;">
                With the power of PHP and MySQL, we were able to make the most
            ...
            <p style="font-size: 15px;">
                ...
                access to the database or know the ID, and to access the database you will literally need to steal our computer.
            </p>
            ...
            <ul style="font-size: 15px; margin-left: 13px;">
                ...
                <li>Any bugs? Let us know via ###</li>
            </ul>

            <br>
            <a class="signup" style="font-size: 15px;" href="index.php">Convinced? Go Back and Sign Up!<a>
